...
# Choose the indices you want to put in div.param.native:
	indX.nat <-c("TD_pa_simpson", "TD_pa_shannon", "TD_ab_simpson", "TD_ab_shannon", "FD_pa_mpd", "FD_pa_mntd", "FD_pa_CWM", "FD_pa_CSD", "FD_ab_mpd", "FD_ab_mntd", "FD_ab_CWM", "FD_ab_CSD", "PD_pa_mpd", "PD_pa_mntd", "PD_pa_faith", "PD_ab_mpd", "PD_ab_mntd", "PD_pa_colless") # never put only 1 index (at least 2), it would change the output format!
